...
4. **Privacidad blindada al nivel del *Datenschutz* alemán (`[D-022] + [D-034]`):** El profesorado y el centro pueden estar tranquilos: ninguna imagen con el nombre y apellidos del alumno llega a internet ni a los servidores de la nube o las empresas de IA. El recorte de la cabecera en el **navegador del docente** (JavaScript/Canvas API, `[D-022]`) destruye los píxeles del nombre antes de cualquier envío; la herramienta visual de tampón en la PWA (`Client-Side Blackout Tool [D-034]`) cubre nombres en márgenes o pies de folio; y la seudonimización pre-nube garantiza un cumplimiento impecable del RGPD y de la LOPDGDD.
