...
| Motor multimodal (OpenAI Vision + Workload Routing)                   | ✅ D-051 / D-052                 | ✅ main (v0.3-004)                 | ✅ pruebas de integración verdes  | ✅ README + decisiones.md        | 🟢 Auditado | Pipeline validado el 12/08/2026. Motor unificado en OpenAI `gpt-4o-mini` (`[D-053]`). Cualitativa ESO determinista en backend. |
